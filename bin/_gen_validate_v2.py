#!/usr/bin/env python3
"""Generate validate_extensions_v2.sh — uses existing clone, correct bundle paths."""
import os
...
BDIR="/fsx/references/runtime_assets/cached_envs/sentieon-genomics-202503.03/bundles"
...
outpath = os.path.join(os.path.dirname(__file__), "validate_extensions_v2.sh")
