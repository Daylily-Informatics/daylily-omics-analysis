#!/usr/bin/env python3
"""Generate validate_extensions.sh — run this script, then SCP the output."""
import os

lines = r"""#!/usr/bin/env bash
set -uo pipefail
...
check_dir "/fsx/runtime_assets/cached_envs/sentieon-genomics-202503.02" "Sentieon 202503.02"
for b in /fsx/runtime_assets/cached_envs/sentieon-genomics-202503.02/share/SentieonHybridIlluminaONT*; do
    check_file "$b" "HybridIlluminaONT: $(basename $b)"
done
check_file "/fsx/runtime_assets/cached_envs/sentieon-genomics-202503.02/share/SentieonIlluminaWGS2.2.bundle" "SegDup SR model"
check_file "/fsx/runtime_assets/cached_envs/sentieon-genomics-202503.02/share/DNAscopeONT2.3.bundle" "SegDup LR model"
...
outpath = os.path.join(os.path.dirname(__file__), "validate_extensions.sh")
