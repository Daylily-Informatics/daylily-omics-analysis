...
ls -la /fsx/references/runtime_assets/cached_envs/sentieon-genomics-202503.02/bundles/ 2>/dev/null || echo "Bundles dir not found"
echo ""
echo "--- Search for PacBio bundle ---"
find /fsx/references/runtime_assets/cached_envs/sentieon-genomics-202503.02/ -name "*PacBio*" -o -name "*pacbio*" 2>/dev/null || echo "No PacBio bundles found"
echo ""
echo "--- Search for diploid_model ---"
find /fsx/references/runtime_assets/cached_envs/sentieon-genomics-202503.02/ -name "diploid_model*" 2>/dev/null || echo "No diploid_model found"
