...
rule sentieon_pangenome_sr:
    ...
    resources:
        ...
        distribution=config["sentieon_pangenome_sr"]["distribution"],
        exclude=config["sentieon_pangenome_sr"]["exclude"],
        include=config["sentieon_pangenome_sr"]["include"],
        exclusive=config["sentieon_pangenome_sr"]["exclusive"],
    params:
    ...
    shell:
        ...
        # Use local NVME /scratch for TMPDIR; shared memory is too small for 30x+ WGS.
        export TMPDIR="/scratch/pangenome_sr_tmp_${{timestamp}}_$$";
...
rule clear_combined_pangenome_sr_vcf:  # TARGET: clear combined pangenome sr vcf
    ...
    log:
        MDIR + "logs/clear_combined_pangenome_sr_vcf.log"
    benchmark:
        "logs/benchmarks/clear_combined_pangenome_sr_vcf.bench.tsv"
    threads: 2
    priority: 42
    shell:
        """
...
rule produce_pangenome_sr_vcf:  # TARGET: sentieon pangenome vcf
    ...
    benchmark:
        "logs/benchmarks/produce_pangenome_sr_vcf.bench.tsv"
    shell:
        """( touch {output} ;
