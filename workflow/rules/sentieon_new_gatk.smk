...
rule sentieon_gatk_bsqr:
    ...
    shell:
        ...
        # --- QualCal (BSQR) ---
        LD_PRELOAD=$LD_PRELOAD /fsx/runtime_assets/cached_envs/sentieon-genomics-202503.02/bin/sentieon driver \
            -t {threads} \
            -r {params.huref} \
            -i {input.cram} \
            --algo QualCal \
...
rule sentieon_gatk_snv:
    ...
    shell:
        ...
        /fsx/runtime_assets/cached_envs/sentieon-genomics-202503.02/bin/sentieon driver \
