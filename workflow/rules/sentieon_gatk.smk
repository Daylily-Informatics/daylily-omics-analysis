...
rule sentieon_gatk_bsqr_og:  #TARGET: sent bwa sort
    ...
    log: MDIR + "{sample}/align/{alnr}/{ddup}/snv/gatk/logs/{sample}.{alnr}.{ddup}.gatk.bsqr.sort.log",
...
rule sentieon_gatk_snv_og:  #TARGET: sent bwa sort
    ...
    log: MDIR + "{sample}/align/{alnr}/{ddup}/snv/gatk/logs/{sample}.{alnr}.{ddup}.gatk.snv.sort.log",
    threads: config["sentieon_gatk"]["threads"]
    benchmark:
