...
def build_parser() -> argparse.ArgumentParser:
    ...
    coverage.add_argument("--rr-bed-sha256", required=True)
    ...
    coverage.add_argument("--callable-definition", required=True)
    ...
    boundary.add_argument("--rr-bed-sha256", required=True)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "coverage-from-mosdepth":
        row = build_coverage_row_from_mosdepth(
            ...
            rr_bed_sha256=args.rr_bed_sha256,
