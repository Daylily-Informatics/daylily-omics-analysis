#!/usr/bin/env python3
"""Launch full-depth two-sample SMN12 DayOA live run in an ubuntu tmux session."""
...
SESSION = "dayoa_smn12_full_chip124_20260615T092300Z_live"
LIVE_LOG = "logs/live_smn12_full_chip124_20260615T092300Z.log"
PATCH_LOG = "logs/smn12_runtime_patch_full_chip124_live_20260615T092300Z.log"
...
"""
    result = run_shell(
        ...
        timeout=120,
        comment="Launch full-depth SMN12 chip124 DayOA live tmux",
    )
