...
WORKDIR="/fsx/analysis_results/ubuntu/hg003a_altair3_hiomr_ilmn20x_ont7x_1022/daylily-omics-analysis"
...
{
    echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] DS-002 launch verification."
