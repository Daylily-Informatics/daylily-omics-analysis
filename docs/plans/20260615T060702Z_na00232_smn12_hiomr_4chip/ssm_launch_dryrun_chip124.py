#!/usr/bin/env python3
"""Launch NA00232 chip124 DayOA dry-run in an ubuntu tmux session."""
...
SESSION = "dayoa_na00232_smn12_chip124_20260615T062929Z_dryrun"
DRYRUN_LOG = "logs/dryrun_smn12_chip124_20260615T062929Z.log"
PATCH_LOG = "logs/smn12_runtime_patch_chip124_20260615T062929Z.log"
...
"""
    result = run_shell(
        ...
        timeout=120,
        comment="Launch NA00232 chip124 DayOA dry-run tmux",
    )
